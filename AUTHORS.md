...
The initial release is an independently developed contribution. Jianing Liu is
responsible for:

- Conceptualization;
- Methodology;
- Software and Skill authoring;
- Validation and regression-case design;
- Investigation and evidence review;
- Data curation and de-identification decisions;
- Writing — original draft;
- Writing — review and editing;
- Visualization and documentation;
- Project administration and maintenance.

Generative AI tools assisted with drafting, coding, comparison, and quality
checks. They are not authors or contributors. The named author selected the
research questions, approved the rules and releases, reviewed the evidence,
and remains accountable for the repository contents.
...
The initial contributor is affiliated with:
